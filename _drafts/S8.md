...
There are a few small surprises in the box, such as the inclusion of some decent AKG tuned headphones, and 2 USB Type C adapters.  Things that Microsoft didn't include for the Lumia 950 which would have been nice.  Everything else is the quality you would expect for a phone of this price range, just watch the video above and decide for yourself.
...
I'm even using an app on my phone to write, preview *and* publish this blog post.  Using [MrHyde](https://play.google.com/store/apps/details?id=org.faudroids.mrhyde), check it out if you have a Jekyll site stored on GitHub.
